...
const Create =()=> {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const existingCurrency = await axios.get(`https://currency-rate.onrender.com/api/currencies/name/${name}`);
      ...
      const response = await axios.post('https://currency-rate.onrender.com/api/currencies', currencyData);
