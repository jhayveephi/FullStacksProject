...
const Read = () => {
  ...
  const fetchCurrencies = async () => {
    try {
      const response = await axios.get('https://currency-rate.onrender.com/api/currencies');
  ...
  const deleteCurrency = async (name) => {
    try {
      await axios.delete(`https://currency-rate.onrender.com/api/currencies/deleteByName/${name}`);
